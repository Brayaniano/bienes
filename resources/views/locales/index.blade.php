                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        @foreach ($locales as $local)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" id="row">
                                ...
                                <td>
                                    <a href="{{ route('locals.edit', ['id' => $local->id]) }}">
                                    ...
                                    <a href="{{ url('/local',['id' => $local->id]) }}">
                                        ...
                                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full" onClick="deletePiso('{{ route('locals.delete', ['id' => $local->id]) }}')">
                                            Eliminar
                                        </button>
                                </td>
                            </tr>
