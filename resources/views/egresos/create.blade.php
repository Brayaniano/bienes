<x-app-layout>
    ...
    @if(isset($value) && $value != false)
    {
        <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
            ...
            <div>
                <p class="font-bold">Egreso Registrado!</p>
            </div>
            </div>
      </div>
    }
    ...
    @if(isset($error) && $error != false)
    {
        <div class="bg-red-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md" role="alert">
            ...
            <div>
                ...
                <p class="text-sm">La cuenta no está asociada a ningún bien</p>
            </div>
            </div>
      </div>
    }
    ...
    <div class="py-12">
        ...
        <form method="POST" action="{{ route('egresos') }}">
            @csrf
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Selecciona una Cuenta</label>
                    <select id="id_cuenta" name="id_cuenta" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
