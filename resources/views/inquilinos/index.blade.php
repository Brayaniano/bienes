...
// Obtener el campo de búsqueda por su ID
const identificationFilterInput = document.getElementById('identificationFilter');

// Escuchar eventos de entrada en el campo de búsqueda
identificationFilterInput.addEventListener('input', function() {
    // Obtener el valor ingresado en el campo de búsqueda
    const identification = this.value.toLowerCase().trim();

    // Obtener todas las filas de la tabla
    const rows = document.querySelectorAll('#row');

    // Iterar sobre las filas y mostrar/ocultar según la identificación ingresada
    rows.forEach(row => {
        const identificationColumn = row.querySelector('th:first-child');
        if (identificationColumn.textContent.toLowerCase().includes(identification)) {
            row.style.display = ''; // Mostrar la fila si coincide con la identificación
        } else {
            row.style.display = 'none'; // Ocultar la fila si no coincide con la identificación
        }
    });
});
